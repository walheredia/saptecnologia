...
@section('content')
	@if(Session::has('error'))
    		<div class="alert alert-danger alert-dismissable">
			  ...
			  <strong>¡Error!</strong> El usuario "{{ Session::get('error') }}" no tiene suficientes privilegios para realizar realizar la acción que desea.
			</div>
	@endif
    <div class="jumbotron">
    	<div class="container">	
		  <h1 align="Center">SAP 2016 - Tecnología - Byte Transfer</h1>
		</div>
